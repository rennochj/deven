# This file is generated from .deven-ec2-spot/compute/main.tf.deven. All changes to this file may be overwritten. 

module "deven_ec2_spot" {

  source = "/Users/rennochj/code/deven/modules/deven-ec2-spot"
